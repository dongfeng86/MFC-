...
class CWordRange : public COleDispatchDriver
{
public:
	CWordRange() {} // 调用 COleDispatchDriver 默认构造函数
	CWordRange(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordRange(const CWordRange& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0x44e, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		BOOL result;
		InvokeHelper(0x8d, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x13d, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	void SetRange(long Start, long End)
	{
		...
		InvokeHelper(0x64, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Start, End);
	}
	void Collapse(VARIANT * Direction)
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x65, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Direction);
	}
	...
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x68, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Text);
	}
	...
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x7a, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Type);
	}
	void InsertFile(LPCTSTR FileName, VARIANT * Range, VARIANT * ConfirmConversions, VARIANT * Link, VARIANT * Attachment)
	{
		...
		InvokeHelper(0x7b, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileName, Range, ConfirmConversions, Link, Attachment);
	}
	...
	void InsertDateTimeOld(VARIANT * DateTimeFormat, VARIANT * InsertAsField, VARIANT * InsertAsFullWidth)
	{
		...
		InvokeHelper(0xa3, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, DateTimeFormat, InsertAsField, InsertAsFullWidth);
	}
	void InsertSymbol(long CharacterNumber, VARIANT * Font, VARIANT * Unicode, VARIANT * Bias)
	{
		...
		InvokeHelper(0xa4, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, CharacterNumber, Font, Unicode, Bias);
	}
	void InsertCrossReference_2002(VARIANT * ReferenceType, long ReferenceKind, VARIANT * ReferenceItem, VARIANT * InsertAsHyperlink, VARIANT * IncludePosition)
	{
		...
		InvokeHelper(0xa5, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ReferenceType, ReferenceKind, ReferenceItem, InsertAsHyperlink, IncludePosition);
	}
	void InsertCaptionXP(VARIANT * Label, VARIANT * Title, VARIANT * TitleAutoText, VARIANT * Position)
	{
		...
		InvokeHelper(0xa6, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Label, Title, TitleAutoText, Position);
	}
	void CopyAsPicture()
	{
	...
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0xa8, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ExcludeHeader, FieldNumber, SortFieldType, SortOrder, FieldNumber2, SortFieldType2, SortOrder2, FieldNumber3, SortFieldType3, SortOrder3, SortColumn, Separator, CaseSensitive, LanguageID);
	}
	void SortAscending()
	{
	...
	void PasteSpecial(VARIANT * IconIndex, VARIANT * Link, VARIANT * Placement, VARIANT * DisplayAsIcon, VARIANT * DataType, VARIANT * IconFileName, VARIANT * IconLabel)
	{
		...
		InvokeHelper(0xb0, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, IconIndex, Link, Placement, DisplayAsIcon, DataType, IconFileName, IconLabel);
	}
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xb3, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Direction);
	}
	void CheckSynonyms()
	{
	...
	void SubscribeTo(LPCTSTR Edition, VARIANT * Format)
	{
		...
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Edition, Format);
	}
	void CreatePublisher(VARIANT * Edition, VARIANT * ContainsPICT, VARIANT * ContainsRTF, VARIANT * ContainsText)
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0xb6, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Edition, ContainsPICT, ContainsRTF, ContainsText);
	}
	void InsertAutoText()
	{
	...
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0xc2, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Format, Style, LinkToSource, Connection, SQLStatement, SQLStatement1, PasswordDocument, PasswordTemplate, WritePasswordDocument, WritePasswordTemplate, DataSource, From, To, IncludeFields);
	}
	void AutoFormat()
	{
	...
	void CheckSpelling(VARIANT * CustomDictionary, VARIANT * IgnoreUppercase, VARIANT * AlwaysSuggest, VARIANT * CustomDictionary2, VARIANT * CustomDictionary3, VARIANT * CustomDictionary4, VARIANT * CustomDictionary5, VARIANT * CustomDictionary6, VARIANT * CustomDictionary7, VARIANT * CustomDictionary8, VARIANT * CustomDictionary9, VARIANT * CustomDictionary10)
	{
		...
		InvokeHelper(0xcd, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, CustomDictionary, IgnoreUppercase, AlwaysSuggest, CustomDictionary2, CustomDictionary3, CustomDictionary4, CustomDictionary5, CustomDictionary6, CustomDictionary7, CustomDictionary8, CustomDictionary9, CustomDictionary10);
	}
	...
	void ConvertHangulAndHanja(VARIANT * ConversionsMode, VARIANT * FastConversion, VARIANT * CheckHangulEnding, VARIANT * EnableRecentOrdering, VARIANT * CustomDictionary)
	{
		...
		InvokeHelper(0xdd, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ConversionsMode, FastConversion, CheckHangulEnding, EnableRecentOrdering, CustomDictionary);
	}
	...
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0xdf, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Style, Symbol, EnclosedText);
	}
	void PhoneticGuide(LPCTSTR Text, long Alignment, long Raise, long FontSize, LPCTSTR FontName)
	{
		...
		InvokeHelper(0xe0, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Text, Alignment, Raise, FontSize, FontName);
	}
	...
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0x1bc, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, DateTimeFormat, InsertAsField, InsertAsFullWidth, DateLanguage, CalendarType);
	}
	void Sort(VARIANT * ExcludeHeader, VARIANT * FieldNumber, VARIANT * SortFieldType, VARIANT * SortOrder, VARIANT * FieldNumber2, VARIANT * SortFieldType2, VARIANT * SortOrder2, VARIANT * FieldNumber3, VARIANT * SortFieldType3, VARIANT * SortOrder3, VARIANT * SortColumn, VARIANT * Separator, VARIANT * CaseSensitive, VARIANT * BidiSort, VARIANT * IgnoreThe, VARIANT * IgnoreKashida, VARIANT * IgnoreDiacritics, VARIANT * IgnoreHe, VARIANT * LanguageID)
	{
		...
		InvokeHelper(0x1e4, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ExcludeHeader, FieldNumber, SortFieldType, SortOrder, FieldNumber2, SortFieldType2, SortOrder2, FieldNumber3, SortFieldType3, SortOrder3, SortColumn, Separator, CaseSensitive, BidiSort, IgnoreThe, IgnoreKashida, IgnoreDiacritics, IgnoreHe, LanguageID);
	}
	void DetectLanguage()
	{
	...
	void TCSCConverter(long WdTCSCConverterDirection, BOOL CommonTerms, BOOL UseVariants)
	{
		...
		InvokeHelper(0x1f3, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, WdTCSCConverterDirection, CommonTerms, UseVariants);
	}
	...
	{
		float result;
		InvokeHelper(0x108, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x109, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x10a, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_TwoLinesInOne(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x10a, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x10b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_NoProofing()
	{
		long result;
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x144, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_Scripts()
	{
		LPDISPATCH result;
		InvokeHelper(0x145, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x147, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x190, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_BoldBi(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x190, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_ItalicBi()
	{
		long result;
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x19c, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Type);
	}
	void PasteExcelTable(BOOL LinkedToExcel, BOOL WordFormatting, BOOL RTF)
	{
		static BYTE parms[] = VTS_BOOL VTS_BOOL VTS_BOOL;
		InvokeHelper(0x19d, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, LinkedToExcel, WordFormatting, RTF);
	}
	void PasteAppendTable()
	{
		InvokeHelper(0x19e, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	LPDISPATCH get_XMLNodes()
	{
		LPDISPATCH result;
		InvokeHelper(0x154, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_XMLParentNode()
	{
		LPDISPATCH result;
		InvokeHelper(0x155, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_Editors()
	{
		LPDISPATCH result;
		InvokeHelper(0x157, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		VARIANT result;
		InvokeHelper(0x159, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_BSTR VTS_PVARIANT;
		InvokeHelper(0x1a0, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, XML, Transform);
	}
	void InsertCaption(VARIANT * Label, VARIANT * Title, VARIANT * TitleAutoText, VARIANT * Position, VARIANT * ExcludeLabel)
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0x1a1, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Label, Title, TitleAutoText, Position, ExcludeLabel);
	}
	void InsertCrossReference(VARIANT * ReferenceType, long ReferenceKind, VARIANT * ReferenceItem, VARIANT * InsertAsHyperlink, VARIANT * IncludePosition, VARIANT * SeparateNumbers, VARIANT * SeparatorString)
	{
		...
		InvokeHelper(0x1a2, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ReferenceType, ReferenceKind, ReferenceItem, InsertAsHyperlink, IncludePosition, SeparateNumbers, SeparatorString);
	}
	...
	{
		VARIANT result;
		InvokeHelper(0x1a4, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	VARIANT get_ParagraphStyle()
	{
		VARIANT result;
		InvokeHelper(0x1a5, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	VARIANT get_ListStyle()
	{
		VARIANT result;
		InvokeHelper(0x1a6, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	VARIANT get_TableStyle()
	{
		VARIANT result;
		InvokeHelper(0x1a7, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_ContentControls()
	{
		LPDISPATCH result;
		InvokeHelper(0x1a8, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	void ExportFragment(LPCTSTR FileName, long Format)
	{
		static BYTE parms[] = VTS_BSTR VTS_I4;
		InvokeHelper(0x1a9, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileName, Format);
	}
	CString get_WordOpenXML()
	{
		CString result;
		InvokeHelper(0x1aa, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void SetListLevel(short Level)
	{
		static BYTE parms[] = VTS_I2;
		InvokeHelper(0x1ab, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Level);
	}
	void InsertAlignmentTab(long Alignment, long RelativeTo)
	{
		static BYTE parms[] = VTS_I4 VTS_I4;
		InvokeHelper(0x1f4, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Alignment, RelativeTo);
	}
	...
	void ImportFragment(LPCTSTR FileName, BOOL MatchDestination)
	{
		...
		InvokeHelper(0x1f6, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileName, MatchDestination);
	}
	void ExportAsFixedFormat(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, BOOL ExportCurrentPage, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, BOOL BitmapMissingFonts, BOOL UseISO19005_1, VARIANT * FixedFormatExtClassPtr)
	{
		...
		InvokeHelper(0x1f7, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, OutputFileName, ExportFormat, OpenAfterExport, OptimizeFor, ExportCurrentPage, Item, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts, UseISO19005_1, FixedFormatExtClassPtr);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1fa, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	void SortByHeadings(VARIANT * SortFieldType, VARIANT * SortOrder, VARIANT * CaseSensitive, VARIANT * BidiSort, VARIANT * IgnoreThe, VARIANT * IgnoreKashida, VARIANT * IgnoreDiacritics, VARIANT * IgnoreHe, VARIANT * LanguageID)
	{
		...
		InvokeHelper(0x1fc, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, SortFieldType, SortOrder, CaseSensitive, BidiSort, IgnoreThe, IgnoreKashida, IgnoreDiacritics, IgnoreHe, LanguageID);
	}
	void ExportAsFixedFormat2(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, BOOL ExportCurrentPage, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, BOOL BitmapMissingFonts, BOOL UseISO19005_1, BOOL OptimizeForImageQuality, VARIANT * FixedFormatExtClassPtr)
	{
		static BYTE parms[] = VTS_BSTR VTS_I4 VTS_BOOL VTS_I4 VTS_BOOL VTS_I4 VTS_BOOL VTS_BOOL VTS_I4 VTS_BOOL VTS_BOOL VTS_BOOL VTS_BOOL VTS_PVARIANT;
		InvokeHelper(0x1fd, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, OutputFileName, ExportFormat, OpenAfterExport, OptimizeFor, ExportCurrentPage, Item, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts, UseISO19005_1, OptimizeForImageQuality, FixedFormatExtClassPtr);
	}
