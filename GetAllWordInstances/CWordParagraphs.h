// CWordParagraphs 包装器类
class CWordParagraphs : public COleDispatchDriver
{
public:
	CWordParagraphs() {} // 调用 COleDispatchDriver 默认构造函数
	CWordParagraphs(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordParagraphs(const CWordParagraphs& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
