...
class CWordSelection : public COleDispatchDriver
{
public:
	CWordSelection() {} // 调用 COleDispatchDriver 默认构造函数
	CWordSelection(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordSelection(const CWordSelection& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x9a, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0xd6, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ShiftCells);
	}
	void Extend(VARIANT * Character)
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x12c, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Character);
	}
	void Shrink()
	{
	...
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x1fb, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Text);
	}
	void CopyFormat()
	{
	...
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x210, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, NumRows);
	}
	void InsertColumns()
	{
	...
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0x212, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Formula, NumberFormat);
	}
	...
	{
		InvokeHelper(0x215, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	...
	void DetectLanguage()
	{
		InvokeHelper(0x217, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void SelectCell()
	{
		InvokeHelper(0x218, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void InsertRowsBelow(VARIANT * NumRows)
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x219, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, NumRows);
	}
	void InsertColumnsRight()
	{
		InvokeHelper(0x21a, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void InsertRowsAbove(VARIANT * NumRows)
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x21b, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, NumRows);
	}
	void RtlRun()
	{
		InvokeHelper(0x258, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void LtrRun()
	{
		InvokeHelper(0x259, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void BoldRun()
	{
		InvokeHelper(0x25a, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void ItalicRun()
	{
		InvokeHelper(0x25b, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void RtlPara()
	{
		InvokeHelper(0x25d, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void LtrPara()
	{
		InvokeHelper(0x25e, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	...
	void Sort2000(VARIANT * ExcludeHeader, VARIANT * FieldNumber, VARIANT * SortFieldType, VARIANT * SortOrder, VARIANT * FieldNumber2, VARIANT * SortFieldType2, VARIANT * SortOrder2, VARIANT * FieldNumber3, VARIANT * SortFieldType3, VARIANT * SortOrder3, VARIANT * SortColumn, VARIANT * Separator, VARIANT * CaseSensitive, VARIANT * BidiSort, VARIANT * IgnoreThe, VARIANT * IgnoreKashida, VARIANT * IgnoreDiacritics, VARIANT * IgnoreHe, VARIANT * LanguageID)
	{
		...
		InvokeHelper(0x1bd, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ExcludeHeader, FieldNumber, SortFieldType, SortOrder, FieldNumber2, SortFieldType2, SortOrder2, FieldNumber3, SortFieldType3, SortOrder3, SortColumn, Separator, CaseSensitive, BidiSort, IgnoreThe, IgnoreKashida, IgnoreDiacritics, IgnoreHe, LanguageID);
	}
	...
	{
		BOOL result;
		InvokeHelper(0x3ef, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	...
	{
		float result;
		InvokeHelper(0x3f0, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		InvokeHelper(0x3f1, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void PasteAppendTable()
	{
		InvokeHelper(0x3f2, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	LPDISPATCH get_HTMLDivisions()
	{
		LPDISPATCH result;
		InvokeHelper(0x3f3, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x3fd, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_HasChildShapeRange()
	{
		BOOL result;
		InvokeHelper(0x3fe, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_FootnoteOptions()
	{
		LPDISPATCH result;
		InvokeHelper(0x400, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_EndnoteOptions()
	{
		LPDISPATCH result;
		InvokeHelper(0x401, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	void ToggleCharacterCode()
	{
		InvokeHelper(0x3f4, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void PasteAndFormat(long Type)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x3f5, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Type);
	}
	void PasteExcelTable(BOOL LinkedToExcel, BOOL WordFormatting, BOOL RTF)
	{
		static BYTE parms[] = VTS_BOOL VTS_BOOL VTS_BOOL;
		InvokeHelper(0x3f6, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, LinkedToExcel, WordFormatting, RTF);
	}
	void ShrinkDiscontiguousSelection()
	{
		InvokeHelper(0x3fb, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void InsertStyleSeparator()
	{
		InvokeHelper(0x3fc, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void Sort(VARIANT * ExcludeHeader, VARIANT * FieldNumber, VARIANT * SortFieldType, VARIANT * SortOrder, VARIANT * FieldNumber2, VARIANT * SortFieldType2, VARIANT * SortOrder2, VARIANT * FieldNumber3, VARIANT * SortFieldType3, VARIANT * SortOrder3, VARIANT * SortColumn, VARIANT * Separator, VARIANT * CaseSensitive, VARIANT * BidiSort, VARIANT * IgnoreThe, VARIANT * IgnoreKashida, VARIANT * IgnoreDiacritics, VARIANT * IgnoreHe, VARIANT * LanguageID, VARIANT * SubFieldNumber, VARIANT * SubFieldNumber2, VARIANT * SubFieldNumber3)
	{
		...
		InvokeHelper(0x3ff, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ExcludeHeader, FieldNumber, SortFieldType, SortOrder, FieldNumber2, SortFieldType2, SortOrder2, FieldNumber3, SortFieldType3, SortOrder3, SortColumn, Separator, CaseSensitive, BidiSort, IgnoreThe, IgnoreKashida, IgnoreDiacritics, IgnoreHe, LanguageID, SubFieldNumber, SubFieldNumber2, SubFieldNumber3);
	}
	...
	void InsertXML(LPCTSTR XML, VARIANT * Transform)
	{
		...
		InvokeHelper(0x404, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, XML, Transform);
	}
	...
	{
		CString result;
		InvokeHelper(0x13d, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void ClearParagraphStyle()
	{
		InvokeHelper(0x406, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void ClearCharacterAllFormatting()
	{
		InvokeHelper(0x407, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void ClearCharacterStyle()
	{
		InvokeHelper(0x408, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void ClearCharacterDirectFormatting()
	{
		InvokeHelper(0x409, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	LPDISPATCH get_ContentControls()
	{
		LPDISPATCH result;
		InvokeHelper(0x40a, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	void ExportAsFixedFormat(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, BOOL ExportCurrentPage, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, BOOL BitmapMissingFonts, BOOL UseISO19005_1, VARIANT * FixedFormatExtClassPtr)
	{
		...
		InvokeHelper(0x40c, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, OutputFileName, ExportFormat, OpenAfterExport, OptimizeFor, ExportCurrentPage, Item, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts, UseISO19005_1, FixedFormatExtClassPtr);
	}
	...
	{
		InvokeHelper(0x40e, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void ClearParagraphAllFormatting()
	{
		InvokeHelper(0x40f, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void ClearParagraphDirectFormatting()
	{
		InvokeHelper(0x410, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void InsertNewPage()
	{
		InvokeHelper(0x411, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void SortByHeadings(VARIANT * SortFieldType, VARIANT * SortOrder, VARIANT * CaseSensitive, VARIANT * BidiSort, VARIANT * IgnoreThe, VARIANT * IgnoreKashida, VARIANT * IgnoreDiacritics, VARIANT * IgnoreHe, VARIANT * LanguageID)
	{
		...
		InvokeHelper(0x412, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, SortFieldType, SortOrder, CaseSensitive, BidiSort, IgnoreThe, IgnoreKashida, IgnoreDiacritics, IgnoreHe, LanguageID);
	}
	void ExportAsFixedFormat2(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, BOOL ExportCurrentPage, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, BOOL BitmapMissingFonts, BOOL UseISO19005_1, BOOL OptimizeForImageQuality, VARIANT * FixedFormatExtClassPtr)
	{
		...
		InvokeHelper(0x413, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, OutputFileName, ExportFormat, OpenAfterExport, OptimizeFor, ExportCurrentPage, Item, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts, UseISO19005_1, OptimizeForImageQuality, FixedFormatExtClassPtr);
	}
