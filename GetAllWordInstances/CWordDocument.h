...
{
public:
	CWordDocument() {} // 调用 COleDispatchDriver 默认构造函数
...
public:
	...
	BOOL get_TrackJustMyRevisions()
	{
		BOOL result;
		InvokeHelper(0x273, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_TrackJustMyRevisions(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
