// CWordParagrap 包装器类
class CWordParagraph : public COleDispatchDriver
{
public:
	CWordParagraph() {} // 调用 COleDispatchDriver 默认构造函数
	CWordParagraph(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordParagraph(const CWordParagraph& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0x44f, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		long result;
		InvokeHelper(0x77, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x7a, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x7c, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	void TabHangingIndent(short Count)
	{
		...
		InvokeHelper(0x130, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Count);
	}
	void TabIndent(short Count)
	{
		static BYTE parms[] = VTS_I2;
		InvokeHelper(0x132, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Count);
	}
	void Reset()
	{
	...
	{
		static BYTE parms[] = VTS_I2;
		InvokeHelper(0x140, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Count);
	}
	void IndentFirstLineCharWidth(short Count)
	{
		static BYTE parms[] = VTS_I2;
		InvokeHelper(0x142, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Count);
	}
	...
	{
		static BYTE parms[] = VTS_R4;
		InvokeHelper(0x80, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	float get_LineUnitBefore()
	{
		float result;
		InvokeHelper(0x81, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, nullptr);
		return result;
	}
	void put_LineUnitBefore(float newValue)
	{
		static BYTE parms[] = VTS_R4;
		InvokeHelper(0x81, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	float get_LineUnitAfter()
	{
		float result;
		InvokeHelper(0x82, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		BOOL result;
		InvokeHelper(0x86, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void SelectNumber()
	{
	...
	void ListAdvanceTo(short Level1, short Level2, short Level3, short Level4, short Level5, short Level6, short Level7, short Level8, short Level9)
	{
		...
		InvokeHelper(0x150, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Level1, Level2, Level3, Level4, Level5, Level6, Level7, Level8, Level9);
	}
	void ResetAdvanceTo()
	{
	...
	{
		BOOL result;
		InvokeHelper(0x4b3, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CollapsedState(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x4b3, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CollapseHeadingByDefault()
	{
		BOOL result;
		InvokeHelper(0x4b4, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
