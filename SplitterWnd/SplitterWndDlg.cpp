...
CSplitterWndDlg::CSplitterWndDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_SPLITTERWND_DIALOG, pParent)
{
...
void CSplitterWndDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CSplitterWndDlg::OnQueryDragIcon()
{
