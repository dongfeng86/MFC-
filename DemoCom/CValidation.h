...
public:
	...
	void Add(long Type, VARIANT& AlertStyle, VARIANT& Operator, VARIANT& Formula1, VARIANT& Formula2)
	{
		...
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Type, &AlertStyle, &Operator, &Formula1, &Formula2);
	}
	long get_AlertStyle()
	{
		long result;
	...
	{
		CString result;
		InvokeHelper(0x649, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void put_ErrorMessage(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x649, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	CString get_ErrorTitle()
	{
		CString result;
		InvokeHelper(0x64a, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	...
	{
		CString result;
		InvokeHelper(0x64b, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void put_InputMessage(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x64b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	CString get_InputTitle()
	{
		CString result;
		InvokeHelper(0x64c, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	...
	{
		CString result;
		InvokeHelper(0x62b, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	CString get_Formula2()
	{
		CString result;
		InvokeHelper(0x62c, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void Modify(VARIANT& Type, VARIANT& AlertStyle, VARIANT& Operator, VARIANT& Formula1, VARIANT& Formula2)
	{
		...
		InvokeHelper(0x62d, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, &Type, &AlertStyle, &Operator, &Formula1, &Formula2);
	}
	long get_Operator()
	{
		long result;
		InvokeHelper(0x31d, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	BOOL get_ShowError()
	{
		BOOL result;
		InvokeHelper(0x64d, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_ShowError(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x64d, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_ShowInput()
	{
		BOOL result;
		InvokeHelper(0x64e, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
